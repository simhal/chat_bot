<script lang="ts">
    ...
    import { getAdminArticles, deleteArticle, rateArticle, generateContent, downloadArticlePDF } from '$lib/api';
...
{#if selectedArticle && showRatingModal}
    <div class="modal-overlay" on:click={() => { selectedArticle = null; showRatingModal = false; userRating = 0; }}>
        <div class="modal" on:click|stopPropagation>
            ...
            {#if userRating > 0}
                <p class="rating-text">Rating: {userRating}/5</p>
            {/if}
