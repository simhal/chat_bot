"""V2 Agent Build - Experimental playground (forked from v1)."""
...
@register_build("v2")
class V2Build(AgentBuildBase):
    """
    V2 Agent Build - Experimental playground.

    Forked from V1 for experimentation. Make changes here without
    affecting the production v1 build.
